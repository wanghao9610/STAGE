...
# Kimi runs hooks from the project root, those entries then cover every STAGE
...
echo "  they now run in every STAGE paper repository — no per-project setup needed."
