...
description: >-
  ...
  the skill that owns the file. Use when the user runs /skill:stage-clms-auditor, when a run names it as
  the next action, or asks whether the paper's numbers are backed by evidence, or before any submission
  freeze.
---
