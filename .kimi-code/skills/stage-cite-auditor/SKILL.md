...
description: >-
  ...
  citations and bib hygiene. Use when the user runs /skill:stage-cite-auditor, /stage-auto starts it,
  or asks whether the citations and related-work claims hold up. Read-only on the manuscript, the bib,
