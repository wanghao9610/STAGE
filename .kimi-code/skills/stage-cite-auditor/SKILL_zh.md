...
description: >-
  ...
  wkdrs/reports/CITES_<date>.md（临时）外加 tasks/ 后续条目，并把每一处修复路由给 /skill:stage-refs-curator 或
  /skill:stage-sect-drafter。只要用户运行 /skill:stage-cite-auditor、一次运行点名它是下一步动作，或询问引用与 相关工作的说法站不站得住，都应使用本
  skill。
---
