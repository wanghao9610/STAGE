...
description: >-
  ...
  /skill:stage-* command. Reports in chat only and points every action at the sibling skill that owns
  it. Use when the user runs /skill:stage-flow-status, or asks where the paper stands, what to work on
