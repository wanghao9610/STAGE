...
description: >-
  ...
  runs /skill:stage-copy-editor, /stage-auto starts it, or asks to polish, tighten, proofread,
  de-jargon, cut formulaic or AI-like phrasing, restore the author's voice, or set the style. Never
  changes technical meaning, a number, a \cite or \ref key, or a \todo; content cuts are routed, not
  applied.
---
