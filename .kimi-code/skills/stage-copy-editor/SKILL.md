...
description: >-
  ...
  manuscript still builds. Use when the user runs /skill:stage-copy-editor, when a run names it as the
  next action, or asks to polish, tighten, proofread, or de-jargon the paper's prose.
---
...
Invocation: `/skill:stage-copy-editor [SECTION]` — a section argument resolves by number, file slug, or
