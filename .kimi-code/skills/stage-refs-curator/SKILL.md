...
description: >-
  ...
  /skill:stage-cite-auditor to verify manuscript assertions against, and the index
  ...
  /skill:stage-refs-curator, or asks to add a reference or reading note, clean or deduplicate the
