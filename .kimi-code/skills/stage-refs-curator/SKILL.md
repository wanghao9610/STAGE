...
description: >-
  ...
  /skill:stage-cite-auditor checks against; and the index notes/refs/refs_index.md. Every entry carries a
  ...
  fetchable record goes to manual check, never guessed. Use when the user runs /skill:stage-refs-curator,
