...
<!-- Written by /skill:stage-refs-curator. This file is the audit trail for manus/bibs/reference.bib:
...
<!-- One row per entry, the arithmetic and bins from source-policy.md (Impact score): sub-signals
     ...
     the dates say how fresh, and /skill:stage-refs-curator score rebuilds this table. -->
...
<!-- Gaps worth another pass (a thin category, a cited work with no note, a legacy citekey the
     ...
     /skill:stage-cite-auditor; drafting Related Work from the clusters → /skill:stage-sect-drafter; one more
     paper later → /skill:stage-refs-curator <arxiv-id>; searching for work nobody has named →
     /skill:stage-refs-curator discover; re-checking the whole bib →
     /skill:stage-refs-curator verify; refreshing drifted citation and star metrics →
     /skill:stage-refs-curator score. -->
