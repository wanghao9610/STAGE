...
arXiv-only entries, ‡ in the index. The tier reflects vetting, not quality — a `new`-flagged preprint may simply not be through review yet; `source-policy.md`'s flag rule says how prose treats it.
