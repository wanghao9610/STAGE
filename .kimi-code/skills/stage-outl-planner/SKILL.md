...
description: >-
  ...
  when the user runs /skill:stage-outl-planner, or asks to outline the paper, budget sections against
  the page limit, set up section files, or turn the story into a skeleton.
---
