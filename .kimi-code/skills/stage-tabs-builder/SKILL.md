...
description: >-
  ...
  Tables row and the claim ledger. Use when the user runs /skill:stage-tabs-builder, when a run names it
  as the next action, or asks to build, fill, extend, or fix a results, ablation, or comparison table, or
  to turn imported results into LaTeX.
---
