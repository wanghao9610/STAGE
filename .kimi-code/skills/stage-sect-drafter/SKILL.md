...
1. Read the conventions file (whole file, own `ReadFile` call), then `notes/story.md` (pitch, active `cycle:`), `notes/outline.md`, `notes/claims.md`, and `notes/notation.md`.
