...
Invocation: `/skill:stage-subm-packer [camera | convert] [kit=<path>] [DESCRIPTION] [involve=high]`
— no argument packs a review submission for the active cycle, resolved per conventions §5 from `cycle:`
