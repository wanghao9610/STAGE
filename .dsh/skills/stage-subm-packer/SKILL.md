...
description: >-
  ...
  /skill:stage-subm-packer, or asks to package, freeze, convert, or prepare a submission,
  camera-ready, or arXiv source. Never fetches or reconstructs a template, uploads, pushes, or edits
  the manuscript.
---
