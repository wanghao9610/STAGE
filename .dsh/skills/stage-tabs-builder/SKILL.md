...
description: >-
  ...
  \todo{...} cell that opens an unsourced claim. Use when the user runs /skill:stage-tabs-builder, a
  run names it next, or asks to build, fill, extend, or fix a results, ablation, or comparison table,
  or turn imported results into LaTeX. No number comes from memory, chat, or recalled papers.
---
