...
- The skills themselves: authored in `.claude/skills/`, ported mechanically to six other harnesses, and deduplicated under `.agents/skills/`; `SKILL_zh.md` beside each is its Chinese edition, kept in step for human readers and never loaded at runtime.
