...
![STAGE writing workflow: fifteen skills in the order they run in plus one that reads across them, what each one writes, and how the drafting loop and the rejection loop close](stage-writing-workflow.png)
