#!/usr/bin/env bash
# Generate STAGE's seven skill trees from the authored copy in .claude/skills.
#
...
#
# The seven trees ship the same sixteen skills to seven agent harnesses, and each
