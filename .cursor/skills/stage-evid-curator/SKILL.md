...
3. One AskQuestion for what no probe can know: `source` — where this came from (path, URL, or person) — and `shows`, skipped when the user's request already said both.
