...
4. Approval: one question via AskQuestion — approve all, approve by group (sections / figures / tables / bibs / styles), or abort. Unapproved rows do not move.
