...
argument-hint: "[PAPER | add | discover | seed | tidy | position | verify | score]"
allowed-tools: >-
  Read, Grep, Glob, Write, Edit, Bash(bash execs/scpts/import.sh:*),
  Bash(execs/scpts/import.sh:*), Agent, WebSearch, WebFetch, Bash(git status:*),
