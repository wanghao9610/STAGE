...
allowed-tools: >-
  ...
  Bash(bash execs/scpts/import.sh --diff:*), Bash(execs/scpts/import.sh --diff:*),
  Bash(shasum -a 256:*), Bash(sha256sum:*), Bash(date +%Y-%m-%d), Bash(date +%F), Agent,
  Bash(git status:*), Bash(git diff:*), Bash(git log:*), Bash(git tag:*), Bash(git add:*),
  Bash(git commit:*)
---
