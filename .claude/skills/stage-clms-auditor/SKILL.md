...
allowed-tools: >-
  Read, Grep, Glob, Write, Edit, Bash(bash execs/scpts/import.sh --diff:*),
  Bash(execs/scpts/import.sh --diff:*), Bash(shasum -a 256:*), Bash(sha256sum:*),
  Bash(bash execs/scpts/lint.sh:*), Bash(execs/scpts/lint.sh:*), Bash(date +%Y-%m-%d),
