...
description: >-
  ...
  checkbox under tasks/, and mark conceded claims weakened. Use when the user invokes
  stage-resp-writer, or asks to draft a rebuttal or response letter, answer reviewers point by point,
  or decide what to concede. Never edits the manuscript or the review files.
---
