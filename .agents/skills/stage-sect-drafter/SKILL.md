...
description: >-
  ...
  notes/outline.md and writes manus/secs/n_slug.tex; every number either traces to a fingerprinted
  ...
  section's outline row. Never edits mates/ and never re-scopes the outline. Use when the user invokes
