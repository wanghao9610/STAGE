...
description: >-
  ...
  wkdrs/reports/CITES_date.md (ephemeral) plus tasks/ follow-ups, and routes every fix to
  stage-refs-curator or stage-sect-drafter. Use when the user invokes stage-cite-auditor, when a run
